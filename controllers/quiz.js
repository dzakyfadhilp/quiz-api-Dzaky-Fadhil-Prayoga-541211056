...
// CREATE: untuk menampilkan data kedalam tabel quiz
...
exports.update = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            messages: error.message || "Some error occured while retrieving quiz",
            data: null,
        });
    }
}
...
exports.getByCategoryId = async (req, res) => {
    ...
    res.json({
        message: `Quizzes retrieved succesfully with cateroryId=${id}.`,
        data: quizzes,
    });
}
